...
class VisualEffectSubviewContainer extends StatefulWidget {
  ...
  static const topLeftCorner = VisualEffectSubviewContainerWithGlobalKey.topLeftCorner;
  static const topRightCorner = VisualEffectSubviewContainerWithGlobalKey.topRightCorner;
  static const bottomRightCorner = VisualEffectSubviewContainerWithGlobalKey.bottomRightCorner;
  static const bottomLeftCorner = VisualEffectSubviewContainerWithGlobalKey.bottomLeftCorner;
  ...
  const VisualEffectSubviewContainer({Key? key, required this.child, this.alphaValue = 1.0, this.cornerRadius, this.cornerMask = 0xf, required this.effect, this.state = MacOSBlurViewState.followsWindowActiveState, this.padding = EdgeInsets.zero, this.resizeEventRelay}) : super(key: key);

  @override
  State<VisualEffectSubviewContainer> createState() => _VisualEffectSubviewContainerState();
}

class _VisualEffectSubviewContainerState extends State<VisualEffectSubviewContainer> {
