...
void main() {
  testWidgets(
      'visual effect subview container resize event relay no resize event '
  ...
  testWidgets(
      'visual effect subview container resize event relay resize event '
      'triggered once', (tester) async {
    final relay = VisualEffectSubviewContainerResizeEventRelay(
        disableUpdateOnBuild: false);
