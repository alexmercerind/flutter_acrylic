...
import 'package:flutter_acrylic/widgets/visual_effect_subview_container/visual_effect_subview_container_property_storage.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  testWidgets('visual effect subview container property storage frame size change test', (tester) async {
    ...
    expect(delta1, VisualEffectSubviewProperties(
      frameWidth: 1.0,
      frameHeight: 2.0,
    ));
    ...
    expect(delta2, VisualEffectSubviewProperties(
      frameWidth: 2.0,
      frameHeight: 2.0,
    ));
  });
  
  testWidgets('visual effect subview container property storage frame position change test', (tester) async {
    final storage = VisualEffectSubviewContainerPropertyStorage();
    storage.updateProperties(VisualEffectSubviewProperties(
      frameWidth: 1.0,
      frameHeight: 1.0,
  ...
  testWidgets('visual effect subview container property storage alpha value change test', (tester) async {
    final storage = VisualEffectSubviewContainerPropertyStorage();
    storage.updateProperties(VisualEffectSubviewProperties(
      alphaValue: 1.0,
    ));
    ...
    expect(delta, VisualEffectSubviewProperties(
      alphaValue: 0.0
    ));
  });
  
  testWidgets('visual effect subview container property storage corner change test', (tester) async {
    final storage = VisualEffectSubviewContainerPropertyStorage();
    storage.updateProperties(VisualEffectSubviewProperties(
      cornerRadius: 0.0,
    ));
  ...
  testWidgets('visual effect subview container property storage effect change test', (tester) async {
    final storage = VisualEffectSubviewContainerPropertyStorage();
    storage.updateProperties(VisualEffectSubviewProperties(
