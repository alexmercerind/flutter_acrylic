...
#define FLUTTER_ACRYLIC_PLUGIN(obj) (G_TYPE_CHECK_INSTANCE_CAST((obj), flutter_acrylic_plugin_get_type(), FlutterAcrylicPlugin))
...
static void flutter_acrylic_plugin_handle_method_call(FlutterAcrylicPlugin* self, FlMethodCall* method_call) {
...
void flutter_acrylic_plugin_register_with_registrar(FlPluginRegistrar* registrar) {
  FlutterAcrylicPlugin* plugin = FLUTTER_ACRYLIC_PLUGIN(g_object_new(flutter_acrylic_plugin_get_type(), nullptr));
